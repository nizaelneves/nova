...
const GITHUB_BASE =
  'https://github.com/nizaelneves/nova/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/nizaelneves/nova.git\ncd Nova\nuv sync"} />
