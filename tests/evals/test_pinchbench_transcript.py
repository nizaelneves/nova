...
from nova.evals.core.event_recorder import AgentEvent, EventType
from nova.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from nova.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Nova tool names are mapped to PinchBench-expected names."""
    from nova.evals.scorers.pinchbench import events_to_transcript
