...
from nova.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from nova.evals.core.runner import _result_to_trace_dict
...
class TestDirectBackendGpuMetrics:
    ...
    @patch("nova.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("nova.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from nova.evals.core.config import expand_suite
