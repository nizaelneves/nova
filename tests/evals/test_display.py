"""Tests for the Rich display helpers in nova.evals.core.display."""
...
from nova.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Nova" in output or "___" in output
