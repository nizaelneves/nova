"""Tests for nova.evals.backends.external.openclaw.OpenClawBackend."""
    ...
    return ThirdPartyConfig(
        entries={
            "openclaw": ThirdPartyEntry(
                ...
                runner_script=(
                    "src/nova/evals/backends/external/_runners/openclaw_runner.mjs"
                ),
                node_executable="",
            )
        }
...
class TestOpenClawBackend:
    def test_generate_full_builds_correct_subprocess_command(
        ...
        with (
            patch(
                "nova.evals.backends.external.openclaw.load_third_party_config",
                return_value=cfg,
            ),
            patch(
                "nova.evals.backends.external.openclaw.verify_commit_pin",
            ),
            patch(
                "nova.evals.backends.external.openclaw.run_one_shot",
            ) as mock_run,
        ):
