...
class TestBrowserNavigateTool:
    def test_spec_name_and_category(self):
        from nova.tools.browser import BrowserNavigateTool
    ...
    def test_execute_playwright_not_installed(self):
        ...
        with patch("nova.tools.browser._session", session):
            tool = BrowserNavigateTool()
    ...
    def test_execute_ssrf_blocked(self):
        ...
        with patch.dict(
            "sys.modules",
            {"nova.security.ssrf": mock_ssrf_module},
        ):
            tool = BrowserNavigateTool()
...
class TestBrowserClickTool:
    def test_spec_name_and_category(self):
        from nova.tools.browser import BrowserClickTool
...
class TestBrowserTypeTool:
    def test_spec_name_and_category(self):
        from nova.tools.browser import BrowserTypeTool
...
class TestBrowserScreenshotTool:
    def test_spec_name_and_category(self):
        from nova.tools.browser import BrowserScreenshotTool
...
class TestBrowserExtractTool:
    def test_spec_name_and_category(self):
        from nova.tools.browser import BrowserExtractTool
...
class TestBrowserSession:
    def test_session_close_resets_state(self):
        from nova.tools.browser import _BrowserSession
...
class TestRegistryIntegration:
    ...
    def test_module_exports(self):
        from nova.tools.browser import __all__
