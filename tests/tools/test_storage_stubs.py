...
class TestStorageStubs:
    ...
    def test_backward_compat_import(self) -> None:
        ...
        from nova.tools.storage._stubs import MemoryBackend as MB
        from nova.tools.storage._stubs import RetrievalResult as RR
    ...
    def test_sqlite_backward_compat(self) -> None:
        ...
        from nova.tools.storage.sqlite import SQLiteMemory as S1
