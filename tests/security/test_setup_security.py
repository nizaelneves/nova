...
from nova.core.config import CapabilitiesConfig, NovaConfig, SecurityConfig
from nova.core.events import EventBus
from nova.security import SecurityContext, setup_security
...
class TestSetupSecurityEnabled:
    ...
    def test_enabled_policy_fails_closed_when_initialization_fails(
        ...
        monkeypatch.setattr(
            "nova.security.capabilities.CapabilityPolicy",
            _broken_policy,
        )
    ...
    def test_server_rate_limiter_fails_closed_when_initialization_fails(
        ...
        monkeypatch.setattr(
            "nova.security.rate_limiter.RateLimiter",
            _broken_limiter,
        )
