...
from nova.mcp.protocol import MCPRequest
...
class TestStreamableHTTPTransport:
    def test_send_request(self, _mock_httpx_client):
        ...
        from nova.mcp.transport import StreamableHTTPTransport
    ...
    def test_backward_compat_alias(self):
        ...
        from nova.mcp.transport import SSETransport, StreamableHTTPTransport
