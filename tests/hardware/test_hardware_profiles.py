...
class TestDetectHardware:
    ...
    @patch("nova.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "nova.core.config._run_cmd",
    ...
    @patch("nova.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "nova.core.config._run_cmd",
        side_effect=[
    ...
    @patch("nova.core.config.platform.system", return_value="Darwin")
    @patch(
        "nova.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("nova.core.config.shutil.which", return_value=None)
    @patch("nova.core.config.platform.system", return_value="Linux")
