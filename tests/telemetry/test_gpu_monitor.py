...
def _snap(power=300, util=80, mem=12, temp=65, dev=0):
    ...
    from nova.telemetry.gpu_monitor import GpuSnapshot
...
class TestGpuHardwareSpec:
    def test_lookup_exact_key(self):
        from nova.telemetry.gpu_monitor import lookup_gpu_spec
    ...
    def test_all_specs_present(self):
        from nova.telemetry.gpu_monitor import GPU_SPECS
...
class TestContextManager:
    def test_sample_context_manager(self):
        ...
        import nova.telemetry.gpu_monitor as mod
...
class TestDataclasses:
    ...
    def test_gpu_sample_defaults(self):
        from nova.telemetry.gpu_monitor import GpuSample
