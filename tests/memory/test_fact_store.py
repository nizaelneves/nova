"""Tests for the persistent fact store (nova.memory.store)."""
...
from nova.core.registry import FactStoreRegistry
...
def test_create_fact_store_default_path_uses_nova_home(tmp_path, monkeypatch):
