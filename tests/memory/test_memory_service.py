"""Tests for the background memory service (nova.memory.service)."""
...
from nova.core.config import StorageConfig
...
from nova.memory.store import Fact, FactStore, LocalFactStore
...
def test_extracted_facts_reach_model_context_end_to_end(tmp_path):
    ...
    from nova.tools.storage.context import inject_context
