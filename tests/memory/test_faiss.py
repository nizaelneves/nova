...
from nova.core.events import (  # noqa: E402
    EventBus,
    EventType,
)
from nova.core.registry import MemoryRegistry  # noqa: E402
from nova.tools.storage._stubs import RetrievalResult  # noqa: E402
from nova.tools.storage.embeddings import Embedder  # noqa: E402
from nova.tools.storage.faiss_backend import (  # noqa: E402
    FAISSMemory,
)
...
def test_event_bus_store():
    ...
    import nova.tools.storage.faiss_backend as mod
