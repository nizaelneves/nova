...
from nova.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("nova.speech.deepgram.DeepgramClient", return_value=mock_client):
        from nova.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("nova.speech.deepgram.DeepgramClient"):
        from nova.speech.deepgram import DeepgramSpeechBackend
