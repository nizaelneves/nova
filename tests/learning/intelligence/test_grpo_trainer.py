...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from nova.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from nova.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from nova.core.config import GRPOConfig
        from nova.learning.intelligence.grpo_trainer import GRPOTrainer
