...
class TestACEOptimizerConfig:
    ...
    def test_optimizer_init(self) -> None:
        from nova.core.config import ACEOptimizerConfig
        from nova.learning.agents.ace_optimizer import ACEAgentOptimizer
...
class TestTraceDataProcessor:
    def test_answer_is_correct_substring_match(self) -> None:
        from nova.learning.agents.ace_optimizer import _TraceDataProcessor
...
class TestSplitSamples:
    def test_70_15_15_split(self) -> None:
        from nova.learning.agents.ace_optimizer import _split_samples
...
class TestTracesToSamples:
    def test_drops_empty_query_or_result(self) -> None:
        from nova.learning.agents.ace_optimizer import _traces_to_samples
...
class TestACEOptimizerOptimize:
    ...
    def test_missing_ace_dep_returns_error(self) -> None:
        from nova.core.config import ACEOptimizerConfig
        from nova.learning.agents import ace_optimizer
