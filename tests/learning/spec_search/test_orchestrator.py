...
from nova.learning.spec_search.triggers import OnDemandTrigger
...
def _make_diagnosis_result():
    from nova.learning.spec_search.diagnose.runner import DiagnosisResult
...
class TestSpecSearchOrchestrator:
    def test_full_session_completes(self, tmp_path: Path) -> None:
        from nova.learning.spec_search.orchestrator import (
        ...
        with patch(
            "nova.learning.spec_search.orchestrator.DiagnosisRunner"
        ) as MockDiag:
...
class TestFromConfig:
    def test_from_config_round_trips_paper_defaults(self, tmp_path: Path) -> None:
        from nova.core.config import SpecSearchLearningConfig
        from nova.learning.spec_search.orchestrator import (
            SpecSearchOrchestrator,
        )
