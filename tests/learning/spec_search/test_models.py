"""Tests for nova.learning.spec_search.models module."""
...
class TestEditPillar:
    ...
    def test_has_four_pillars(self) -> None:
        from nova.learning.spec_search.models import EditPillar
...
class TestEditRiskTier:
    ...
    def test_has_three_tiers(self) -> None:
        from nova.learning.spec_search.models import EditRiskTier
...
class TestEditOp:
    ...
    def test_intelligence_ops(self) -> None:
        from nova.learning.spec_search.models import EditOp
...
class TestTriggerKind:
    ...
    def test_four_trigger_kinds(self) -> None:
        from nova.learning.spec_search.models import TriggerKind
...
class TestAutonomyMode:
    ...
    def test_three_modes(self) -> None:
        from nova.learning.spec_search.models import AutonomyMode
...
class TestSessionStatus:
    ...
    def test_all_statuses(self) -> None:
        from nova.learning.spec_search.models import SessionStatus
...
class TestEdit:
    ...
    def _valid_edit_kwargs(self) -> dict:
        from nova.learning.spec_search.models import (
            EditOp,
            EditPillar,
            EditRiskTier,
        )
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nova.learning.spec_search.models import Edit
...
class TestFailureCluster:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nova.learning.spec_search.models import FailureCluster
...
class TestLearningPlan:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nova.learning.spec_search.models import LearningPlan
...
class TestBenchmarkSnapshot:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nova.learning.spec_search.models import BenchmarkSnapshot
...
class TestEditOutcome:
    ...
    def test_applied_outcome(self) -> None:
        from nova.learning.spec_search.models import EditOutcome
...
class TestLearningSession:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nova.learning.spec_search.models import LearningSession
