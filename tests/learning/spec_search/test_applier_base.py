"""Tests for nova.learning.spec_search.execute.base module."""
...
class TestApplyContext:
    ...
    def test_constructs(self, tmp_path: Path) -> None:
        ...
        ctx = ApplyContext(nova_home=tmp_path, session_id="s1")
        assert ctx.nova_home == tmp_path
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from nova.learning.spec_search.execute.base import ValidationResult
...
class TestEditApplierRegistry:
    ...
    def test_register_and_get(self) -> None:
        from nova.learning.spec_search.execute.base import (
            ApplyContext,
            ApplyResult,
            EditApplier,
            EditApplierRegistry,
        ...
        from nova.learning.spec_search.models import Edit, EditOp
