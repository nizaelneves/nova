"""Tests for nova.learning.spec_search.triggers module."""
...
class TestUserFlagTrigger:
    def test_constructs_with_trace_id(self) -> None:
        from nova.learning.spec_search.triggers import UserFlagTrigger
...
class TestScheduledTrigger:
    def test_constructs(self) -> None:
        from nova.learning.spec_search.triggers import ScheduledTrigger
...
class TestClusterTrigger:
    def test_constructs(self) -> None:
        from nova.learning.spec_search.triggers import ClusterTrigger
