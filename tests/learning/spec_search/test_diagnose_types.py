"""Tests for nova.learning.spec_search.diagnose.types module."""
...
class TestTraceMeta:
    ...
    def test_constructs_with_required_fields(self) -> None:
        from nova.learning.spec_search.diagnose.types import TraceMeta
...
class TestBenchmarkTask:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import BenchmarkTask
...
class TestStudentRun:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import StudentRun
...
class TestTeacherRun:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import TeacherRun
...
class TestComparisonResult:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import ComparisonResult
...
class TestToolMeta:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import ToolMeta
...
class TestDiagnosticTool:
    ...
    def test_constructs_with_callable(self) -> None:
        from nova.learning.spec_search.diagnose.types import DiagnosticTool
...
class TestToolCallRecord:
    ...
    def test_constructs(self) -> None:
        from nova.learning.spec_search.diagnose.types import ToolCallRecord
