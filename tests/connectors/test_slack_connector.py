...
def connector(tmp_path: Path):
    ...
    from nova.connectors.slack_connector import SlackConnector  # noqa: PLC0415
...
@patch("nova.connectors.slack_connector._slack_api_auth_test")
@patch("nova.connectors.slack_connector._slack_api_conversations_list")
@patch("nova.connectors.slack_connector._slack_api_conversations_history")
@patch("nova.connectors.slack_connector._slack_api_users_list")
...
@patch("nova.connectors.slack_connector._slack_api_with_retry")
def test_conversations_list_requests_all_conversation_types(mock_retry) -> None:
    ...
    """
    from nova.connectors.slack_connector import (  # noqa: PLC0415
...
def test_end_to_end_ingest_and_search(
    ...
    """
    from nova.connectors.hybrid_search import HybridSearch  # noqa: PLC0415
    from nova.connectors.pipeline import IngestionPipeline  # noqa: PLC0415
    from nova.connectors.store import KnowledgeStore  # noqa: PLC0415
    ...
    from nova.agents.research_loop import _hit_url  # noqa: PLC0415
...
def test_sync_logs_per_type_channel_counts(
    ...
    with caplog.at_level("INFO", logger="nova.connectors.slack_connector"):
        list(connector.sync())
...
def test_handle_callback_rejects_when_auth_test_fails(mock_auth, connector) -> None:
    ...
    from nova.connectors.slack_connector import SlackTokenError  # noqa: PLC0415
