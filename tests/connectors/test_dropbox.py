...
def connector(tmp_path: Path):
    ...
    from nova.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("nova.connectors.dropbox._dropbox_api_list_folder")
@patch("nova.connectors.dropbox._dropbox_api_download")
