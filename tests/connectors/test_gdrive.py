...
def connector(tmp_path: Path):
    ...
    from nova.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("nova.connectors.gdrive._gdrive_api_list_files")
@patch("nova.connectors.gdrive._gdrive_api_export")
