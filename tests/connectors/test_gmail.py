...
def connector(tmp_path: Path):
    ...
    from nova.connectors.gmail import GmailConnector  # noqa: PLC0415
...
@patch("nova.connectors.gmail._gmail_api_list_messages")
@patch("nova.connectors.gmail._gmail_api_get_message")
...
def test_html_to_text_strips_basic_tags() -> None:
    ...
    from nova.connectors.gmail import _html_to_text  # noqa: PLC0415
...
def test_401_triggers_refresh_and_retries_with_new_token(tmp_path: Path) -> None:
    ...
    from nova.connectors import gmail as gmail_mod
...
def test_refresh_raises_when_refresh_token_missing(tmp_path: Path) -> None:
    ...
    from nova.connectors import google_auth
