...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from nova.agents.native_openhands import NativeOpenHandsAgent
        from nova.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_unknown_tool_error(self):
        from nova.mcp.client import MCPClient
        from nova.mcp.protocol import MCPError
        from nova.mcp.server import MCPServer
        from nova.mcp.transport import InProcessTransport
        from nova.tools.calculator import CalculatorTool
...
class TestMemoryPipeline:
    ...
    def test_bm25_index_and_retrieve(self, tmp_path):
        try:
            from nova.tools.storage.bm25 import BM25Memory
        except ImportError:
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from nova.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
