...
from nova.skills.index import SkillIndex
...
class TestSkillIndex:
    def test_load_index(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "nova"
            source = "github.com/nova/skills/research"
            sha256 = "abc123"
            tags = ["research"]
    ...
    def test_search_by_name(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "nova"
            source = "github.com/nova/skills/web_research"
            sha256 = "abc"
            tags = ["research"]
            required_capabilities = []
            ...
            author = "nova"
            source = "github.com/nova/skills/code_review"
            sha256 = "def"
            tags = ["coding"]
            required_capabilities = []
        """)
