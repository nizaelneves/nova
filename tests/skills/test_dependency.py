...
class TestBuildDependencyGraph:
    def test_no_dependencies(self):
        from nova.skills.dependency import build_dependency_graph
...
class TestValidateDependencies:
    def test_valid_topological_sort_simple(self):
        from nova.skills.dependency import validate_dependencies
...
class TestComputeCapabilityUnion:
    def test_single_skill_no_deps(self):
        from nova.skills.dependency import compute_capability_union
