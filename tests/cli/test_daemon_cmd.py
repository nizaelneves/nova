...
from nova.cli.daemon_cmd import _pid_alive, _read_pid, _write_pid
...
class TestDaemonCommands:
    ...
    def test_stop_no_server(self) -> None:
        ...
        with patch("nova.cli.daemon_cmd._read_pid", return_value=None):
    ...
    def test_write_and_read_pid(self, tmp_path: Path) -> None:
        ...
        with (
            patch("nova.cli.daemon_cmd._PID_FILE", pid_file),
            patch("nova.cli.daemon_cmd.DEFAULT_CONFIG_DIR", tmp_path),
            patch("nova.cli.daemon_cmd._pid_alive", return_value=True),
        ):
            _write_pid(12345)
    ...
    def test_status_shows_running(self) -> None:
        ...
        with (
            patch("nova.cli.daemon_cmd._read_pid", return_value=9999),
            patch(
                "nova.cli.daemon_cmd.load_config",
    ...
    def test_start_already_running(self) -> None:
        ...
        with patch("nova.cli.daemon_cmd._read_pid", return_value=42):
...
class TestPidLiveness:
    ...
    def test_read_pid_stale_pid_returns_none(self, tmp_path: Path) -> None:
        ...
        with patch("nova.cli.daemon_cmd._PID_FILE", pid_file):
            assert _read_pid() is None
...
class TestDaemonDetachment:
    ...
    def _spawn_kwargs(platform: str) -> dict:
        ...
        """
        with (
            patch("nova.cli.daemon_cmd._read_pid", return_value=None),
            patch("nova.cli.daemon_cmd._write_pid"),
            patch("nova.cli.daemon_cmd.load_config"),
            patch("nova.cli.daemon_cmd.sys.platform", platform),
            patch("nova.cli.daemon_cmd.subprocess.Popen") as popen,
