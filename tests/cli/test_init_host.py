...
from nova.core.config import generate_default_toml, generate_minimal_toml
...
class TestInitHost:
    ...
    def test_init_host_probes_and_reports(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            mock.patch("nova.cli.init_cmd.DEFAULT_CONFIG_PATH", config_path),
            mock.patch("nova.cli.init_cmd.PrivacyScanner"),
            mock.patch("nova.cli.init_cmd.httpx") as mock_httpx,
        ):
...
class TestGenerateTomlHost:
    def test_minimal_toml_with_host(self) -> None:
        from nova.core.config import HardwareInfo
