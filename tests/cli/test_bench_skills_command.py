...
class TestBenchSkillsCommand:
    ...
    def test_runs_all_conditions_with_mocked_runner(self, tmp_path: Path) -> None:
        ...
        with patch(
            "nova.evals.skill_benchmark.SkillBenchmarkRunner.run_all_conditions",
            return_value=fake_cmp,
        ):
            with patch(
                "nova.evals.skill_benchmark.SkillBenchmarkRunner.write_report",
    ...
    def test_runs_single_condition(self, tmp_path: Path) -> None:
        from nova.evals.skill_benchmark import ConditionResult
        ...
        with patch(
            "nova.evals.skill_benchmark.SkillBenchmarkRunner.run_condition",
