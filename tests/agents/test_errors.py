...
class TestErrorClassification:
    def test_retryable_error(self):
        from nova.agents.errors import RetryableError
    ...
    def test_fatal_error(self):
        from nova.agents.errors import FatalError

        err = FatalError("invalid API key")
        assert err.retryable is False

    def test_escalate_error(self):
        from nova.agents.errors import EscalateError
    ...
    def test_classify_rate_limit(self):
        from nova.agents.errors import classify_error
    ...
    def test_retry_delay_exponential(self):
        from nova.agents.errors import retry_delay
    ...
    def test_suggest_action_context_length(self):
        from nova.agents.errors import FatalError, suggest_action
