...
from nova.agents.channel_agent import ChannelAgent, classify_query
from nova.channels._stubs import (
    BaseChannel,
    ChannelHandler,
    ChannelMessage,
    ChannelStatus,
...
class TestChannelAgent:
    ...
    def test_deep_query_sends_preview_and_escalation_link(self):
        ...
        assert len(channel._sent) == 1
        sent_content = channel._sent[0]["content"]
        assert "nova://research/" in sent_content
