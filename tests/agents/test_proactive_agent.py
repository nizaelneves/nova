...
from nova.agents.proactive_agent import (
...
class TestRegisterCron:
    ...
    def test_migrates_legacy_tasks_without_stable_key(self, scheduler):
        ...
        assert current.metadata["nova_task_key"] == "proactive-daily"
...
class TestNotificationChannel:
    def test_telegram_is_configured_without_starting_polling(self):
        ...
        with (
            ...
            patch("nova.core.config.load_config", return_value=config),
            patch(
                "nova.system._channel_kwargs.build_channel_kwargs",
