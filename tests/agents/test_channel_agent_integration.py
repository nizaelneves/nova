...
from nova.agents.channel_agent import ChannelAgent
from nova.agents.deep_research import DeepResearchAgent
from nova.channels._stubs import BaseChannel, ChannelMessage, ChannelStatus
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO nova:// link.
    """
    ...
    assert "nova://" not in sent_content, (
