...
if TYPE_CHECKING:
    ...
    from nova.channels._stubs import BaseChannel
    from nova.learning._stubs import RouterPolicy
    ...
    from nova.speech._stubs import SpeechBackend
...
class NovaSystem:
    ...
    # older positional NovaSystem(...) calls retain their original meaning.
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~nova.channels._stubs.BaseChannel`
