...
<title>Nova — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>Nova</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      Nova runs models on your own hardware. Every inference call that would
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install Nova and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/nizaelneves/nova.git
&& cd Nova && uv sync</code>
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/nizaelneves'
    + 'Nova.git && cd Nova && uv sync';
