...
from nova.server.models import (
    ChatCompletionChunk,
...
def _ensure_identity_prompt(messages: list[Message], app_config) -> list[Message]:
    ...
    identity_already_applied = any(
        message.metadata.get("nova_identity_prompt") for message in system_messages
    )
    ...
    if (
        ...
        try:
            ...
            if query_text:
                ...
                from nova.server.models import ChatMessage
...
def _handle_direct(
    ...
    if bus:
        from nova.telemetry.instrumented_engine import InstrumentedEngine
        from nova.telemetry.wrapper import instrumented_generate
...
def _handle_agent(
    ...
    *,
    ...
    if audio_path:
        ...
        from nova.server.models import AudioMeta
    ...
    *,
    ...
    async def generate():
        ...
        try:
            ...
            logging.getLogger("nova.server").error(
...
async def _handle_stream(
    ...
    *,
    ...
    from nova.server.cloud_router import stream_cloud, stream_local
...
async def list_models(request: Request) -> ModelListResponse:
    ...
    """
    from nova.server.cloud_router import is_cloud_model, list_local_models
...
async def security_scan():
    ...
    from nova.cli.scan_cmd import PrivacyScanner
