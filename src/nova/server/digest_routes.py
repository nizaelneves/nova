...
from nova.cli.digest_cmd import (
...
def _generate_digest_sync() -> str:
    """Generate a digest with the whole Nova lifecycle on one worker."""
    from nova.sdk import Nova

    with Nova() as nova:
        return nova.ask("Generate my morning digest", agent="morning_digest")
