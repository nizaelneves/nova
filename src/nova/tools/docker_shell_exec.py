...
:func:`nova.tools.docker_shell_exec.set_active_container`). When no
container is active the tool refuses to run — it is explicitly not a
host-shell alternative.

The expected lifecycle is:

    from nova.tools.docker_shell_exec import set_active_container
...
from nova.tools._stubs import BaseTool, ToolResult, ToolSpec
