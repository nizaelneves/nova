...
class BaseTool(ABC):
    ...
    def to_openai_function(self) -> Dict[str, Any]:
        ...
        from nova.tools.description_loader import (
...
class ToolExecutor:
    ...
    def __init__(
        ...
        *,
        ...
        try:
            from nova.security.taint import TaintSet
        ...
        try:
            from nova.security.injection_scanner import InjectionScanner
    ...
    def begin_session(self, content: List[str] | None = None) -> None:
        ...
        try:
            from nova.security.taint import TaintSet, auto_detect_taint
    ...
    def execute(self, tool_call: ToolCall) -> ToolResult:
        ...
        if self._capability_policy is not None:
            from nova.security.capabilities import canonical_tool_capabilities
        ...
        try:
            from nova.security.taint import TaintSet, check_taint
