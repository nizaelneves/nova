...
Routes incoming :class:`~nova.channels._stubs.ChannelMessage` objects
...
from nova.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Nova:\nnova://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~nova.agents._stubs.BaseAgent`
        subclass).
    max_workers:
