...
Renamed from ``ReActAgent`` to clarify this is Nova's native
...
from nova.agents.prompt_loader import (
...
from nova.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from nova.engine._stubs import InferenceEngine
from nova.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $NOVA_HOME override for the base template (M2+ work).
        prompt_template = (
