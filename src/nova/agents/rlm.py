...
from nova.agents.rlm_repl import RLMRepl
...
RLM_SYSTEM_PROMPT = (
    ...
    "Nova tool and return its textual output.\n"
...
class RLMAgent(ToolUsingAgent):
    ...
    def _execute_tool_from_repl(self, tool_name: str, params: Dict[str, Any]) -> str:
        """Execute a real Nova tool from within the REPL."""
