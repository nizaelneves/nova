...
called from your app startup:
    ...
    from nova.agents.proactive_agent import register_cron
...
from nova.tools.proactive_tools import get_store
...
_PROACTIVE_TASK_KEY_FIELD = "nova_task_key"
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from nova.tools.channel_tools import ChannelSendTool
        from nova.tools.digest_collect import DigestCollectTool
        from nova.tools.proactive_tools import (
            CheckPermissionTool,
