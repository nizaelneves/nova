...
2. Wraps ``chat.completions.create`` with:
   ...
   - A **per-org semaphore** (``NOVA_OPENAI_MAX_CONCURRENCY``,
...
_MAX_CONCURRENCY = _env_int("NOVA_OPENAI_MAX_CONCURRENCY", 4)
_MAX_RETRIES = _env_int("NOVA_OPENAI_MAX_RETRIES", 8)
_RETRY_BASE = _env_float("NOVA_OPENAI_RETRY_BASE", 2.0)
_RETRY_CAP = _env_float("NOVA_OPENAI_RETRY_CAP", 60.0)
