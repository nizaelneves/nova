...
matrix (see ``.nova/experiments/hybrid/docs/results-table.md``).
...
from nova.agents.hybrid._prices import cost as estimate_cost
from nova.agents.hybrid._prices import default_max_output_tokens
