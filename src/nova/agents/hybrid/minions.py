...
from nova.agents.hybrid._openai_retry import (
    patch_openai_globally as _patch_openai_globally,
)
from nova.agents.hybrid._prices import NO_TEMP_PREFIXES, default_max_output_tokens
from nova.agents.hybrid.mini_swe_agent import run_swe_agent_loop
...
def _prefetch_context(
    ...
    try:
        ...
        from nova.agents.hybrid._prices import cost as _cost_usd
