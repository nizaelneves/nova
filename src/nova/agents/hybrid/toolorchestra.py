...
from nova.agents.hybrid._base import (
...
from nova.agents.hybrid.mini_swe_agent import (
    _clone_repo,
    _extract_diff,
    run_swe_agent_loop,
)
...
# Map the orchestrator's `model` slot to a concrete Nova worker spec.
...
def _call_tavily_search(
    ...
    Token counts are reported as zero (no LLM was billed); the Nova
...
_MODAL_APP_NAME = "nova-toolorchestra-sandbox"
