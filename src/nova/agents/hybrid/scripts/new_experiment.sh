...
# src/nova/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m nova.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m nova.agents.hybrid.runner --cell ${name}"
