...
scope for the Nova port (and was out of scope in the hybrid harness).
...
from nova.agents.hybrid._base import LocalCloudAgent
from nova.agents.hybrid._prices import supports_temperature
