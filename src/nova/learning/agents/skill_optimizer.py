...
``~/.nova/learning/skills/<skill-name>/optimized.toml``.
...
from nova.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from nova.core.config import DSPyOptimizerConfig
        from nova.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from nova.learning.agents.gepa_optimizer import GEPAAgentOptimizer
