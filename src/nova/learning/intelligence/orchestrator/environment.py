...
Adapted from IPW's ``environment.py``.  Uses Nova's
:class:`~nova.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Nova ``ToolExecutor``.
