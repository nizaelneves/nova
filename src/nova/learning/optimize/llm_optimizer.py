"""LLM-based optimizer for Nova configuration tuning.

Uses a cloud LLM to propose optimal Nova configs, inspired by DSPy's
...
from nova.core.types import Trace
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Nova configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Nova AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Nova evaluation result.")
        lines.append("")
