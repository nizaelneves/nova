...
from nova.connectors._stubs import BaseConnector
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~nova.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~nova.connectors._stubs.BaseConnector` instance.
