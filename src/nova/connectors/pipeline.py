...
from nova.connectors._stubs import Attachment, Document
from nova.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from nova.connectors.attachment_store import AttachmentStore
