...
Uses OAuth 2.0 tokens stored locally (see :mod:`nova.connectors.oauth`).
...
from nova.connectors.google_auth import call_with_refresh
from nova.connectors.oauth import (
    GOOGLE_ALL_SCOPES,
...
class GCalendarConnector(BaseConnector):
    ...
    credentials_path:
        ...
        ``~/.nova/connectors/gcalendar.json``.
    """
