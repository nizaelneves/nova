...
from nova.core.types import TOKEN_COUNTING_VERSION, Message, TelemetryRecord
from nova.engine._stubs import InferenceEngine, StreamChunk
from nova.telemetry.energy_monitor import BASIS_GPU
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~nova.telemetry.energy_monitor.EnergyMonitor`), it is
