...
def create_energy_monitor(
    ...
    *allow_estimates* is set and nothing measurable is present, a modelled
    ...
    try:
        from nova.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from nova.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from nova.telemetry.energy_rapl import RaplEnergyMonitor
        ...
        try:
            ...
            if AppleEnergyMonitor.estimate_available():
                logger.warning(
                    ...
                    "`nova[energy-apple]` for real measurements."
                )
