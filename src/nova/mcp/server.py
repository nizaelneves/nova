"""MCP Server — wraps Nova tools as MCP-discoverable tools."""
...
class MCPServer:
    """MCP server that exposes Nova tools via JSON-RPC.
    ...
    def _auto_discover_tools() -> List[BaseTool]:
        ...
        try:
            ...
            pass
        try:
            from nova.tools.code_interpreter import CodeInterpreterTool
        ...
        # Storage MCP tools
        try:
            from nova.tools.storage_tools import (
                MemoryIndexTool,
                MemoryRetrieveTool,
                MemorySearchTool,
                MemoryStoreTool,
        ...
        # Channel MCP tools
        try:
            from nova.tools.channel_tools import (
                ChannelListTool,
                ChannelSendTool,
                ChannelStatusTool,
            )
