...
Provides transcript translation (Nova events → PinchBench format),
...
from nova.evals.core.event_recorder import EventType
from nova.evals.core.scorer import LLMJudgeScorer
from nova.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Nova name → PinchBench-expected name
# ---------------------------------------------------------------------------
