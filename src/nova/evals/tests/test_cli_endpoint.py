...
from nova.evals.cli import _build_backend, _run_terminalbench_native
...
class TestBuildBackendForwardsEndpoint:
    @patch("nova.evals.backends.nova_direct.NovaDirectBackend")
    ...
    @patch("nova.evals.backends.nova_agent.NovaAgentBackend")
...
class TestTerminalBenchNativeApiBase:
    @patch("nova.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
...
class TestRunSingleSuiteModeGating:
    @patch("nova.evals.cli._run_terminalbench_native")
    def test_suite_mode_drops_endpoint_for_terminalbench(self, mock_tb):
        from nova.evals.cli import _run_single
