"""Shared helper for resolving the nova repo's HEAD commit."""
...
def nova_commit() -> str:
    """Return the nova repo's HEAD commit (cached, lru-1).
    ...
    """
    try:
        # Walk up to repo root: backends/ -> evals/ -> nova/ -> src/ -> repo
