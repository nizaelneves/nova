...
from nova.evals.backends._commit_util import nova_commit
...
class NovaDirectBackend(InferenceBackend):
    ...
    def __init__(
        ...
        if base_url:
            ...
            from nova.evals.backends._endpoint_util import (
    ...
    def framework_commit_value(self) -> str:
        """Nova repo HEAD commit (for telemetry tagging)."""
        from nova.evals.backends._commit_util import nova_commit
