...
Recipes are the universal composition format for Nova.  Each recipe
...
class Recipe:
    ...
    def to_eval_suite(
        ...
        """
        from nova.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from nova.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.nova/recipes/`` directory
    4. User ``~/.nova/operators/`` directory
