"""High-level Python SDK for Nova."""
...
class MemoryHandle:
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from nova.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from nova.tools.storage.chunking import ChunkConfig
...
class Nova:
    ...
    def version(self) -> str:
        """Return the Nova version string."""
    ...
    def _run_agent(
        ...
        *,
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from nova.tools.digest_collect import DigestCollectTool
            from nova.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from nova.cli.ask import _get_memory_backend, _get_memory_facts
