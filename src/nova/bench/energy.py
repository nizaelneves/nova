...
from nova.bench._stats import compute_stats
from nova.bench._stubs import BaseBenchmark, BenchmarkResult, engine_info
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if energy_monitor is not None:
            from nova.telemetry.steady_state import SteadyStateDetector
