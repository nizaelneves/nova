...
def load_skill(
    ...
    *,
    ...
    if verify_signature and public_key and manifest.signature:
        try:
            from nova.security.signing import verify_b64
    ...
    if scan_for_injection:
        try:
            from nova.security.scanner import SecretScanner
...
def load_skill_directory(path: str | Path) -> SkillManifest:
    ...
    # Promote .source file's source field into manifest.metadata.nova.source
