...
_OUTPUT_START = "---NOVA_OUTPUT_START---"
_OUTPUT_END = "---NOVA_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``nova-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "nova-sandbox:latest"
    DEFAULT_TIMEOUT = 300
